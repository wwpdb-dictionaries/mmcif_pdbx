...
INTERNAL_DATA_DIRS = mmcif_pdbx_v5_next mmcif_pdbx_v41 mmcif_pdbx_v42 mmcif_nmr-star mmcif_sas mmcif_biosync mmcif_ccp4 mmcif_img mmcif_rcsb_nmr mmcif_rcsb_xray mmcif_sym  mmcif_pdbx_v31 mmcif_pdbx_v32 mmcif_nef mmcif_ihm mmcif_ma mmcif_ndb_ntc mmcif_pdbx_vrpt

DATADIRS = $(INTERNAL_DATA_DIRS) $(EXTERNAL_DATA_DIRS)
# Directories in which we perform a checkout function
CHECKOUTDIRS = mmcif_ddl mmcif_pdbx_v5_next mmcif_pdbx_v50 mmcif_ihm mmcif_ma mmcif_pdbx_vrpt
